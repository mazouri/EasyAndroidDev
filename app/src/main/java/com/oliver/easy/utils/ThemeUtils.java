...
public class ThemeUtils {
    ...
    public static int getThemeId(Context context) {
        ...
        int index = Integer.valueOf(SharedPrefenrenceHelper.getSavedTheme());
    ...
    public static void applyWallpaperDim(Activity activity) {
        ...
        int dim = SharedPrefenrenceHelper.getSavedWallpaperDim();
        int alpha = Math.round((float)dim / SharedPrefenrenceHelper.MAX_WALLPAPER_DIM * 255);
